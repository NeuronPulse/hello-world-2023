...
## 🏛️ 历史展览馆 (Historic Exhibition)

这个区域封存了机器人当年在微信群聊中真实调用 API 生成、抓取并发送的产物。它们是 2023 年大模型早期生态最真实的数字标本。

### 🤣 斗图档案馆 (`/doutu/`)
由机器人实时提取群聊关键词，调用 `http://doutu.lccyy.com/api/doutu` 接口下载并发送的经典表情包：

| 开心 💻 | 生气 💢 | 疑问 ❓ | 笑 😆 |
| :---: | :---: | :---: | :---: |
| <img src="./doutu/开心7452176087101307.png" width="150" /> | <img src="./doutu/生气7992693157255775.png" width="150" /> | <img src="./doutu/疑问8122493271464588.png" width="150" /> | <img src="./doutu/笑47138521971788694.png" width="150" /> |
